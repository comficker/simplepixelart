...
useCustomSeoMeta({
  ...
  canonical: "https://simplepixelart.com/privacy",
});
</script>
  ...
  <div class="page">
    ...
    <section>
      ...
      <ul class="policy-list">
        ...
        <li><strong>Cookies:</strong> We use cookies to keep you logged in, remember your preferences, and serve advertisements.</li>
      </ul>
    </section>
    ...
    <section>
      ...
      <ul class="policy-list">
        ...
        <li>To show advertisements that help keep the service free.</li>
      </ul>
    </section>
    ...
    <section>
      ...
      <p>We use Google's Consent Mode v2. On your first visit you'll see a cookie banner asking whether to accept or reject advertising and analytics cookies. Until you make a choice, ad storage, ad personalization, ad user data, and analytics storage are denied by default.</p>
      <p>Your choice is stored in your browser. To change it at any time, clear the <code>sp_consent_v1</code> entry in your browser's local storage (or clear site data for simplepixelart.com) — the banner will reappear on the next visit.</p>
    </section>
    ...
    <section>
      ...
      <p>We retain your account data and published pixel art for as long as your account is active. You can delete your account and associated data by contacting us at <a href="mailto:comficker@gmail.com">comficker@gmail.com</a>.</p>
    </section>

    <section>
      <h2>Children's Privacy</h2>
      <p>SimplePixelArt.com is not directed at children under 13 years of age. We do not knowingly collect personal information from children under 13. If you believe a child has provided us with personal information, please contact us.</p>
    </section>
